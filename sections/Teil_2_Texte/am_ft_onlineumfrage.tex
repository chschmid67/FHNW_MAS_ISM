...
\footnotetext{Der Prozentwert zeigt den Erfüllungsgrad der verschiedenen Themenbereiche auf, wobei 0 mit "`nicht erfüllt"' und 100 mit "`vollständig erfüllt"' gleichgesetzt werden.}
...
\textbf{Block 5} definiert den Frageanteil, welcher jede Frage vom Themenbereich abdeckt. Dieser Frageanteil ist im Regelfall gleichmässig verteilt; hier könnte eine Gewichtung der Antworten vorgenommen werden (die Summe aller Frageanteile muss jedoch immer 100 beragen). Die darauffolgende Zeile listet die berechnete prozentuale Erfüllung aller Fragen auf, d.h. der Durchschnittswert für Fragen vom Typ A, resp- den relevanten prozentualen Ja-, bzw. Nein- Anteil für Fragen vom Typ  B. In der letzten Zeile wird der relative Erfüllungsbetrag des Frageanteils anhand der zuvor bestimmten Werte berechnet und summiert. Diese Summe entspricht dem Erfüllungsgrad des Themenbereiches. Sie wird in der Zusammenfassung als Prozentwert angegeben.}
