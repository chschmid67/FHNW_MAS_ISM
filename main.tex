...
\usepackage{amsmath}                            % - used for math expressions

\usepackage{tikz}                               % - the TikZ drawing package and its used libraries
...
\include{control/hyphenating}

%% - Acronyms & Glossaries
%% - --------------------------------------
\input{control/acronyms.tex}
